...
class ApiCredentialPermission extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $name = 'prionapi:model_api_credential_permission';
    ...
    {
        return config('api.models.api_credential_permission', 'CredentialPermission');
    }
